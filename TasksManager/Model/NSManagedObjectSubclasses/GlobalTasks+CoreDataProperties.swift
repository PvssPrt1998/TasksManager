//
//  GlobalTasks+CoreDataProperties.swift
//  TasksManager
//
...
extension GlobalTasks {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<GlobalTasks> {
        return NSFetchRequest<GlobalTasks>(entityName: "GlobalTasks")
    }
...
extension GlobalTasks : Identifiable {
